...
import { useWithdrawBalance, useUpdateMetadata } from '../hooks/useClientActions';
            ...
            {activityLoading ? (
              ...
              <div className={styles.activityList}>
                      ...
                      <>
                        ...
                        <div className={styles.votesTableWrap}>
                          <table className={styles.votesTable}>
                            ...
                            <tbody>
                              {activity.votes.slice(0, voteDisplayLimit).map((v) => (
                                <tr key={v.id}>
                                  <td>
                ...
                {activityTab === 'proposals' && (
                  <>
                    {activity?.proposals?.length ? activity.proposals.map((p) => {
                ...
                {activityTab === 'bids' && (
                  <>
                    {activity?.bids?.slice(0, 30).map((b) => (
                ...
                {activityTab === 'withdrawals' && (
                  <>
                    {activity?.withdrawals?.slice(0, 20).map((w) => (
