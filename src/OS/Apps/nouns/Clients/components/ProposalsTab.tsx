...
import type { Proposal } from '@/OS/Apps/nouns/Camp/types';
...
const countFormatter = (v: unknown) => Number(v).toLocaleString();
const ethLabelFormatter = (v: unknown) => formatEth(Number(v));
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={votesByClient} margin={{ top: 16, right: 8, bottom: 4, left: 0 }}>
                    ...
                    <Bar dataKey="count" name="Votes" radius={[3, 3, 0, 0]}>
                      ...
                      <LabelList dataKey="count" position="top" fontSize={9} formatter={countFormatter} />
                    </Bar>
                  </BarChart>
                </ResponsiveContainer>
              </div>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={cycleRewardsByClient} margin={{ top: 16, right: 8, bottom: 4, left: 0 }}>
                    ...
                    <Bar dataKey="reward" name="Reward" radius={[3, 3, 0, 0]}>
                      ...
                      <LabelList dataKey="reward" position="top" fontSize={9} formatter={ethLabelFormatter} />
                    </Bar>
                  </BarChart>
                </ResponsiveContainer>
              </div>
