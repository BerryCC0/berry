/**
 * Shared formatting helpers for Food Nouns
 */

import { formatEther } from 'viem';

/** Block number around when the FN protocol was deployed (Aug 2022). */
export const FN_DEPLOY_BLOCK = BigInt(15_000_000);
...
export function fmtShortDate(unixSeconds: number): string {
...
/** Returns minimum next bid in wei given current bid and increment percentage. */
