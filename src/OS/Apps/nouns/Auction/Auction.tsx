 ...
 */
interface AuctionInitialState {
  nounId?: string;
}

/**
 * Type guard for AuctionInitialState
 */
function isAuctionInitialState(state: unknown): state is AuctionInitialState {
          ...
          <div className={styles.statusGrid}>
            ...
            {!viewingNounId && displayAuction ? (
              ...
              <div className={styles.statusItem}>
                ...
                <div className={styles.statusValue}>
                  {loading ? '...' : (
                    isNounder ? NOUNDERS_ENS : truncateAddress(ownerAddress)
                  )}
                </div>
              </div>
            )}
