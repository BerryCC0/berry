...
import { formatBidAmount, NOUNDERS_ADDRESS, NOUNDERS_ENS } from '../utils/auctionHelpers';
  ...
  if (isNounderNoun) {
    return (
      <div className={styles.bidHistory}>
        ...
        <div className={styles.bidsList}>
          <div className={styles.bidItem}>
            <BidderDisplay address={NOUNDERS_ADDRESS} />
            <div className={styles.bidDetails}>
              <span className={styles.bidAmount}>{NOUNDERS_ENS}</span>
            </div>
          </div>
        </div>
      </div>
