/**
 * Big Sur (2020) — SF Symbol-weight line icons
 *
 * macOS Big Sur–Sonoma System Settings style.
 * Stroke-width 1.5, balanced weight, small filled accents.
 * These are the icons extracted from the original CategoryNav.
 */
...
/** Person in circle — Accessibility */
const Accessibility = () => (
  <svg {...svgProps}>
...
export const bigSurGlyphs: GlyphSet = {
