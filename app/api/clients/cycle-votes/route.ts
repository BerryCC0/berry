 ...
 *
 * Uses the shared mainnet client which fails over from Alchemy to public RPCs
 * automatically — viem's default transport (Cloudflare) rate-limits aggressively
 * and used to cause this endpoint to hang under load.
 */
